/** @typedef {{ line: number, column: number }} LineCol */

/** @param {string} source @param {number} offset @returns {LineCol} */
function lineColAtOffset(source, offset) {
...
/** @param {string} source @param {number} line @param {number} column */
function snippetForLine(source, line, column) {
 ...
 * @returns {string}
 */
function formatJsonParseError(source, err, filePath) {
...
module.exports = { formatJsonParseError, lineColAtOffset };
